...
slave_device: messageList[4],
capabilities: messageList[5],
file_capabilities: messageList[6],
mesg_capabilities: messageList[7],
field_capabilities: messageList[8],
device_settings: messageList[9],
user_profile: messageList[10],
hrm_profile: messageList[11],
sdm_profile: messageList[12],
bike_profile: messageList[13],
connectivity: messageList[14],
watchface_settings: messageList[15],
ohr_settings: messageList[16],
zones_target: messageList[17],
sport: messageList[18],
hr_zone: messageList[19],
speed_zone: messageList[20],
cadence_zone: messageList[21],
power_zone: messageList[22],
met_zone: messageList[23],
dive_settings: messageList[24],
dive_alarm: messageList[25],
dive_gas: messageList[26],
goal: messageList[27],
activity: messageList[28],
session: messageList[29],
lap: messageList[30],
length: messageList[31],
record: messageList[32],
event: messageList[33],
device_info: messageList[34],
training_file: messageList[35],
hrv: messageList[36],
weather_conditions: messageList[37],
weather_alert: messageList[38],
gps_metadata: messageList[39],
camera_event: messageList[40],
gyroscope_data: messageList[41],
accelerometer_data: messageList[42],
magnetometer_data: messageList[43],
barometer_data: messageList[44],
three_d_sensor_calibration: messageList[45],
one_d_sensor_calibration: messageList[46],
video_frame: messageList[47],
obdii_data: messageList[48],
nmea_sentence: messageList[49],
aviation_attitude: messageList[50],
video: messageList[51],
video_title: messageList[52],
video_description: messageList[53],
video_clip: messageList[54],
set: messageList[55],
jump: messageList[56],
course: messageList[57],
course_point: messageList[58],
segment_id: messageList[59],
segment_leaderboard_entry: messageList[60],
segment_point: messageList[61],
segment_lap: messageList[62],
segment_file: messageList[63],
workout: messageList[64],
workout_session: messageList[65],
workout_step: messageList[66],
exercise_title: messageList[67],
schedule: messageList[68],
totals: messageList[69],
weight_scale: messageList[70],
blood_pressure: messageList[71],
monitoring_info: messageList[72],
monitoring: messageList[73],
hr: messageList[74],
stress_level: messageList[75],
memo_glob: messageList[76],
ant_channel_id: messageList[77],
ant_rx: messageList[78],
ant_tx: messageList[79],
exd_screen_configuration: messageList[80],
exd_data_field_configuration: messageList[81],
exd_data_concept_configuration: messageList[82],
